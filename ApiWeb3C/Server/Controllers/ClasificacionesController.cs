...
namespace ApiWeb3C.Server.Controllers
{
    ...
    public class ClasificacionesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Equipo>>> GetClasificaciones()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Equipo>> GetClasificacion(int id)
        {
          if (_context.Clasificaciones == null)
          {
              return NotFound();
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutClasificacion(int id, Equipo clasificacion)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Equipo>> PostClasificacion(Equipo clasificacion)
        {
          if (_context.Clasificaciones == null)
          {
